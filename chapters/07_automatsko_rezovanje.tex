...
\begin{lstlisting}[style=python, caption={Z3 провера да је казнени коефицијент $\lambda$ довољно велик.}]
from z3 import *
...
\begin{lstlisting}[style=python, caption={Z3 провера кандидатног решења добијеног квантним или хеуристичким решавачем.}]
from z3 import *
